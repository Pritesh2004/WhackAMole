// Elements
const start_sfx = new Audio('./images/start.mp3');
const hit_sfx = new Audio('./images/hit.mp3');
const hit2_sfx = new Audio('./images/hit2.mp3');
const peep_sfx = new Audio('./images/peep.mp3');
const ding_sfx = new Audio('./images/ding.mp3');
const pam_sfx = new Audio('./images/pam.mp3');
const pum_sfx = new Audio('./images/pum.mp3');
